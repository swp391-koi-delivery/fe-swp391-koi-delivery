            ...
            <div className="w-full px-4">
              <div className="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  ...
                  experience, from cost savings to complete protection of your
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12" data-wow-delay=".1s">
                ...
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  Our service supports free pick-up at your doorstep. You do not
                  need to move, our staff will come to your address to pick up
                  the goods. Free Re-Delivery
                </p>
                <a
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12" data-wow-delay=".15s">
                ...
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  In case the first delivery is unsuccessful, we will re-deliver
                  the next 2 times for free, ensuring that the order reaches the
                  right recipient without incurring additional costs.
                </p>
                <a
                  href="javascript:void(0)"
                  className="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12" data-wow-delay=".2s">
                ...
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  We provide insurance for all orders, ensuring that your goods
                  are safe and compensated in any case of loss or damage.
                </p>
                <a
                  href="javascript:void(0)"
                  className="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-1/4">
              <div className="wow fadeInUp group mb-12" data-wow-delay=".25s">
                ...
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                  With an extensive shipping network and fast delivery service,
                  your order will arrive at its destination in the shortest
                  time, helping you save time.
                </p>
                <a
                  href="javascript:void(0)"
                  className="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
