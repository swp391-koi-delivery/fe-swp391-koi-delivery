...
function Footer() {
  return (
    <>
      ...
      <a
        href="javascript:void(0)"
        className="back-to-top primaryButton fixed bottom-8 left-auto right-8 z-[999] hidden h-10 w-10 items-center justify-center rounded-md shadow-md transition duration-300 ease-in-out"
      >
